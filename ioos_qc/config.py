...
class NcQcConfig(QcConfig):
    ...
    def run(self, path_or_ncd, gen_agg=False, **passedkwargs):
        """ Runs the tests that are defined in the config object.
        ...
        QcConfig.generate_aggregate_flag(gen_agg, results[vname])

        return results

    # TODO: need to think about how we handle qc_agg here. pending cf proposal
